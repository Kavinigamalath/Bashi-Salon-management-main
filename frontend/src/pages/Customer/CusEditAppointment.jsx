...
const EditAppointment = () => {
  ...
  const [employeeOptions, setEmployeeOptions] = useState([]); // Added employeeOptions state
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        ...
        setEmployeeOptions(employeeOptions); // Set employee options here
      } catch (error) {
          ...
          <div>
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-pink-300 transition duration-150 ease-in-out sm:text-sm"
              >
