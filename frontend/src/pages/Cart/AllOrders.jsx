...
const AllOrders = () => {
    ...
    return (
        ...
        <div
            key={order.orderId}
            className="bg-white border border-gray-300 p-4 mb-4 rounded-lg shadow-md relative"
        >
            <h2 className="text-xl font-semibold mb-2">Order ID: {order.orderId}</h2>
            <p className="text-gray-600 mt-2">
                Order Date: {new Date(order.createdAt).toLocaleDateString()}
            </p>
            <div className="flex space-x-4 mt-4 border-t border-gray-300 pt-4">
                    ...
                    <div className="flex flex-row items-start justify-between gap-8">
                        ...
                        <div className="flex-1 pl-4">
                            {order.deliveryInfo?.address ? (
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold mb-2">Dine-in Information:</h3>
