    ...
    const containerStyle = {
      ...
      return (
        <div style={containerStyle}>
            <BackButton destination={`/store`} /> {/* Back button for navigation */}
                ...
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-xl">
                    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
                            ...
                            {/* <div>
                                <label htmlFor="SupplierPhoneNumber" className="block text-sm font-medium leading-5 text-gray-700">SupplierPhoneNumber</label>
                                <input
                                    id="SupplierPhoneNumber"
                                    type="SupplierPhoneNumber"
                                    name="SupplierPhoneNumber"
                                    value={store.SupplierPhoneNumber}
                                    onChange={handleChange}
                                    maxLength={10}
