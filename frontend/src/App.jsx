...
import ReadOneCustomer1 from "./pages/Customer/ReadOneCustomer1";
...
const App = () => {
  return (
    <Routes>
      ...
      {/* <Route path="/editCustomer1/:CusID" element={<EditCustomer />} /> */}
      <Route path="/customers/get/:id" element={<ReadOneCustomer />} />
      <Route path="/customers1/get/:id" element={<ReadOneCustomer1 />} />
      ...
      <Route path="/editCustomer/:CusID" element={<EditCustomer />} />
    </Routes>
  );
};
