        ...
        <div style={screenContentStyle}>
          <form onSubmit={onLogin} style={loginStyle}>
            ...
            <Link to="/customers/create" style={{ textDecoration: 'none' }}>
              <button type="button" style={loginSubmitStyle}>
                <span>Sign Up</span>
                <i className="button__icon fas fa-chevron-right" style={buttonIconStyle}>
                  <FaArrowAltCircleRight />
                </i>
            ...
            {/* Back Button */}
            <button type="button" onClick={handleBackButton} style={loginSubmitStyle}>
              <span>Back</span>
              <i className="button__icon fas fa-chevron-left" style={buttonIconStyle}>
                {/* You can use any icon for the back button */}
                <FaArrowAltCircleRight />
              </i>
            </button>
          </form>
